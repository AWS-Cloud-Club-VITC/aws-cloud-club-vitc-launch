                ...
                >
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between p-6 sm:p-8">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="text-right">
                                    <p className="text-xs text-yellow-500/60 uppercase tracking-widest">Launch Pass</p>
                            ...
                            <div className="space-y-6">
                                <div>
                                    <p className="text-xs text-white/40 uppercase tracking-widest mb-1">Issued To</p>
                                    <h3 className="text-2xl sm:text-3xl font-bold text-white font-heading">{name}</h3>
                                </div>
                                ...
                                <div className="pt-4 border-t border-white/10">
                                    <p className="text-sm text-white/60 italic">"{persona.message}"</p>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 text-center space-y-6">
                            ...
                            <h3 className="text-2xl font-bold text-white font-heading">{persona.title}</h3>
                            <p className="text-white/60 leading-relaxed">
                                {persona.description}
                            </p>

                            <div className="mt-8 pt-8 border-t border-white/10 w-full">
                                <p className="text-sm text-white/30">Flip back to see your pass details</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
