export const deptConfig: Record<
  string,
  {
    label: string;
    isTechnical: boolean;
...
> = {
  ...
  AIML: {
    ...
    project: {
      label: "Project",
      placeholder:
        "Describe your best project. If you are a fresher or have no projects, enter NONE",
      required: true,
    },
    projectLink: {
      label: "Project URL",
      placeholder: "Project URL (GitHub Repo/Deployed Link)",
      required: false,
    },
  ...
  "Network Security": {
    ...
    project: {
      label: "Project",
      placeholder: "Describe your networking or security related projects.",
      required: true,
    },
    projectLink: {
      label: "Project URL",
      placeholder: "Project URL (GitHub/Deployed)",
      required: false,
    },
    github: { required: true },
    questions: [
  ...
  "Cloud & Infrastructure Engineering": {
    ...
    project: {
      label: "Project",
      placeholder:
        "Describe your cloud/infrastructure related projects. If you are a fresher or have no projects, enter NONE",
      required: true,
    },
    projectLink: {
      label: "Project URL",
      placeholder: "Project URL (GitHub/Deployed Link)",
      required: false,
    },
    github: { required: true },
    questions: [
  ...
  "Competitive Programming": {
    ...
    isTechnical: true,
    project: {
      label: "CP Profile Links (LeetCode, HackerRank, etc.)",
      placeholder:
        "Enter your profile links for LeetCode, HackerRank, CodeChef, etc.",
      required: true,
    },
    github: { required: true },
    questions: [
  ...
  "UI/UX Designing": {
    ...
    isTechnical: true,
    project: {
      label: "Portfolio Links (Figma/Drive)",
      placeholder:
        "Paste links to your portfolio (Figma, Behance, Drive, etc.)",
      required: true,
    },
    questions: [
      "Why do you want to join this department?",
  ...
  "Graphic Design & Video Editing": {
    ...
    isTechnical: false,
    project: {
      label: "Links to your portfolio/Work",
      placeholder: "Share your portfolio links or Drive links",
      required: true,
    },
    questions: [
      "Why do you want to join this department?",
...
export const technicalDepts = Object.values(deptConfig)
  .filter((d) => d.isTechnical)
  .map((d) => d.label);
export const nonTechnicalDepts = Object.values(deptConfig)
  .filter((d) => !d.isTechnical)
  .map((d) => d.label);
